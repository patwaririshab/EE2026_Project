...
## Switches
set_property PACKAGE_PIN V17 [get_ports wave_switch]					
	set_property IOSTANDARD LVCMOS33 [get_ports wave_switch]
set_property PACKAGE_PIN V16 [get_ports grid_switch]					
	set_property IOSTANDARD LVCMOS33 [get_ports grid_switch]
set_property PACKAGE_PIN W16 [get_ports axes_switch]					
    set_property IOSTANDARD LVCMOS33 [get_ports axes_switch]
set_property PACKAGE_PIN W17 [get_ports tick_switch]					
	set_property IOSTANDARD LVCMOS33 [get_ports tick_switch]
...
set_property PACKAGE_PIN W2 [get_ports {freq_switch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_switch}]
set_property PACKAGE_PIN U1 [get_ports {noise_switch}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {noise_switch}]
...
##Buttons
set_property PACKAGE_PIN U18 [get_ports middle_button]						
